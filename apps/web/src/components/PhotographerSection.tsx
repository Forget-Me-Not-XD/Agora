                    ...
                    {selected && (
                        <div className="space-y-3">
                            ...
                            <button
                                ...
                                className="w-full px-4 py-2 bg-[var(--color-primary)] text-[var(--color-primary-text)] rounded-xl text-sm font-medium hover:opacity-90 disabled:opacity-50 transition-opacity"
                            >
