...
@Injectable()
export class MicrosoftMobileStrategy extends PassportStrategy(OAuth2Strategy, 'microsoft-mobile') {
    constructor(config: ConfigService) {
        super ({
            ...
            callbackURL: config.get<string>('oauth.microsoft.mobileCallbackUrl')!,
